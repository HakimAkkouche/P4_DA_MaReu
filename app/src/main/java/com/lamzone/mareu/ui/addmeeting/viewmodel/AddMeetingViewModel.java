package com.lamzone.mareu.ui.addmeeting.viewmodel;
...
public class AddMeetingViewModel extends ViewModel {
    ...
    private VerifiedInputs verifyUserInputs() {
        ...
        if (mMeetingName == null || mMeetingName.isEmpty()) {
            meetingNameError = mResources.getString(com.lamzone.mareu.R.string.name_input_error);
        ...
        String roomError;
        if (mRoom == null) {
            roomError = mResources.getString(com.lamzone.mareu.R.string.room_input_error);
            areUserInputOk = false;
        } else {
            roomError = null;
        }
        ...
        if(mParticipants.size() == 0){
            participantError = mResources.getString(com.lamzone.mareu.R.string.participants_input_error);
            areUserInputOk = false;
        }
        else {
