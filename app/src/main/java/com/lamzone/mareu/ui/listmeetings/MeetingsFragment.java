package com.lamzone.mareu.ui.listmeetings;
...
import com.lamzone.mareu.ui.listmeetings.filter_room.OnRoomSelectedListener;
import com.lamzone.mareu.ui.listmeetings.filter_room.RoomFilterAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        requireActivity().addMenuProvider(new MenuProvider() {
            ...
            public boolean onMenuItemSelected(@NonNull MenuItem menuItem) {
                if(menuItem.getItemId() == com.lamzone.mareu.R.id.action_filter_by_room){
                    changeVisibilityWithAnimation(mBinding.meetingRoomsRecyclerview);
                }
                else if(menuItem.getItemId() == com.lamzone.mareu.R.id.action_filter_by_date){
        ...
        mBinding.fabAddMeeting.setOnClickListener(view -> NavHostFragment.findNavController(MeetingsFragment.this)
                .navigate(com.lamzone.mareu.R.id.action_MeetingsFragment_to_AddFragment));
